...
export default function Icons() {
    return (
        <div class="wrapper__links">
            <a href="https://t.me/Vitalik_880" target='_blank'  class="social-link social-link--dribbble" id="dribbble">
                <svg
                    class="social-svg"
                    viewBox="0 0 600 600"
            ...
            <a href="https://github.com/Vitos8" target='_blank' class="social-link social-link--github" id="github">
                <svg
                    class="social-svg"
                    viewBox="0 0 600 600"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.linkedin.com/in/vitalik-golubovich-b81618212/" target='_blank'  class="social-link social-link--linkedin" id="linkedin">
                <svg
                    class="social-svg"
                    viewBox="0 0 600 600"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <a  href="https://www.instagram.com/golubovich.v8/" target='_blank' class="social-link social-link--instagram" id="instagram">
                <svg
                    class="social-svg"
                    viewBox="0 0 600 600"
                    xmlns="http://www.w3.org/2000/svg">
