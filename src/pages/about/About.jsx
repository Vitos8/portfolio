          ...
          <div id='about' className='pt-[100px] pb-[200px]  xs:pb-0 '>
               <div className="flex justify-between items-center lg:flex-col ">
                    ...
                    <div className="lg:order-1 lg:mb-5 lg:flex lg:flex-col lg:justify-center lg:items-center">
                         ...
                         <p className="w-[500px] mb-20 leading-6 base:w-full base:text-xs dark:text-darkLightPurlpe"> I am a front-end (react) developer witn 2 year of experience and i'm open to new opportunities. Very quick to learn, hardworking and confident, honest and responsible, attention to detail and
great problem solving skills, positive attitude and energy , disciplined. For more details, open my resume below. </p>
                         <Button link={'https://cv.djinni.co/ad/f64b38081b236838ee3422bf1c909e/VitalikGolubovichCV.pdf'} color={'blue'} bg={'black'} children={'Download CV'} />
                    </div>
               </div>
          </div>
     )
