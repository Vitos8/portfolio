...
export default function Skills() {
     return (
          <div id='skills' className='py-[150px] xs:pb-[80px]'>
               <h1 className="font-bold text-blue text-lg text-center mb-20 xs:text-[30px]">Technologies</h1>
               ...
               <div className="mt-[133px]">
                    <h4 className='font-bold text-[30px] mb-10 base:text-[24px] xs:text-[18px] xs:leading-5'>Additional technologies and skills</h4>
